...
def convert_zip_send(connection):
    ...
    if os.path.isdir(directory_to_zip):
        ...
        # Compress the file (no encryption yet)
        pyminizip.compress(directory_to_zip, None, output_zip, "", compression_level)
        print(f'Added {base_name} to the zip file.')

    # At this point, output_zip is defined for both directories and files
